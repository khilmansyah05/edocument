...
<head>
  ...
  <link rel="apple-touch-icon" href=" <? echo base_url('thema/classic/base/assets/images/apple-touch-icon.png');?>">
  <link rel="shortcut icon" href="<? echo base_url('classic/base/assets/images/favicon.ico');?>">
  <!-- Stylesheets -->
  <link rel="stylesheet" href="<?echo base_url('classic/global/css/bootstrap.min.css');?>">
  <link rel="stylesheet" href="<?echo base_url('classic/global/css/bootstrap-extend.min.css');?>">
  <link rel="stylesheet" href="<?echo base_url('classic/base/assets/css/site.min.css');?>">
  <!-- Plugins -->
  <link rel="stylesheet" href="<?echo base_url('classic/global/vendor/animsition/animsition.css');?>">
  <link rel="stylesheet" href="<?echo base_url('classic/global/vendor/asscrollable/asScrollable.css');?>">
  <link rel="stylesheet" href="<?echo base_url('classic/global/vendor/switchery/switchery.css');?>">
  <link rel="stylesheet" href="<?echo base_url('classic/global/vendor/intro-js/introjs.css');?>">
  <link rel="stylesheet" href="<?echo base_url('classic/global/vendor/slidepanel/slidePanel.css');?>">
  <link rel="stylesheet" href="<?echo base_url('classic/global/vendor/flag-icon-css/flag-icon.css');?>">
  <link rel="stylesheet" href="<?echo base_url('classic/base/assets/examples/css/pages/login-v3.css');?>">

  <!-- Fonts -->
  <link rel="stylesheet" href="<?echo base_url('classic/global/fonts/web-icons/web-icons.min.css');?>">
  <link rel="stylesheet" href="<?echo base_url('classic/global/fonts/brand-icons/brand-icons.min.css');?>">
  ...
  <!--[if lt IE 10]>
    ...
    <![endif]-->
  <!-- Scripts -->
  <script src="<?echo base_url('classic/global/vendor/breakpoints/breakpoints.js');?>"></script>
  <script>
  Breakpoints();
  </script>
</head>
<body class="animsition page-login-v3 layout-full">
    ...
    <div class="page-content vertical-align-middle animation-slide-top animation-duration-1">
      <div class="panel">
        <div class="panel-body">
          <div class="brand">
            <img class="brand-img" src="classic/base/assets/images/logo-blue.png" alt="...">
            <h2 class="brand-text font-size-18">Sanjiwani</h2>
          </div>
  ...
  <script src="classic/global/vendor/tether/tether.js"></script>
  ...
  <!-- Scripts -->
  <script src="classic/global/js/State.js"></script>
  ...
  <script src="classic/global/js/Plugin/material.js"></script>
  <script>
