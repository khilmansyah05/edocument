        ...
        <ul class="nav navbar-toolbar navbar-right navbar-toolbar-right">
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" role="menu">
              ...
              <a class="dropdown-item" href="<?php echo site_url('user/user_edit')."/". simple_encrypt(id_user()) ?>" role="menuitem"><i class="icon wb-user" aria-hidden="true"></i> Tambah User</a>
        ...
        <div class="scrollable-content">
          <ul class="site-menu" data-plugin="menu" style="transform: translate3d(0px, 0px, 0px);">
            ...
            <li class="site-menu-item has-sub">
              <a  href="<?php echo site_url('user/user_input')?>">
