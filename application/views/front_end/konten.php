...
<head>
  ...
  <!-- Fonts -->
  <link href="<?php echo base_url('assets/fonts/font-awesome/font-awesome.css');?>" rel="stylesheet" />
...
<body>
  <!--[if lt IE 8]>
    ...
    <![endif]-->
  <nav class="navbar-fixed-top navbar-mega navbar-default" role="navigation" style="background-color: #ffffff; box-shadow:0px 2px 5px #000000;">
    ...
    <!-- <div class="navbar-container container-fluid navbar-mega"> -->
      <!-- Navbar Collapse -->
      <div class="container-fluid col-sm-11" style="float:none;" >
        <div class="navbar-header">
          <!-- Navbar Toolbar -->
          <!-- <ul class="nav navbar-toolbar navbar-center navbar-toolbar-center"> -->
          <img src='<?php echo base_url("assets/images/sanjiwani.png"); ?>' style="width:100px;height:50px; margin-top:7px; " title="sanjiwani"></img>
          ...
          <!-- <div class="menu clearfix sf-js-enabled" style="touch-action: pan-y;"> -->
            <ul class="nav navbar-toolbar navbar-right">
              <li class="nav-item" id="toggleMenubar">
                <a class="nav-link" style="color:black" href="<?php echo site_url('home')?>" >Event
                </a>
              </li>
              <li class="nav-item" id="toggleMenubar">
                <a class="nav-link"  style="color:black" href="<?php echo site_url('customer/pendaftaran')?>" >Pendaftaran
                </a>
              </li>
              <li class="nav-item" id="toggleMenubar">
                <a class="nav-link"  style="color:black" href="<?php echo site_url('home/alur_pendaftaran')?>" >Alur Pendaftaran
                </a>
              </li>
              <li class="nav-item" id="toggleMenubar">
                <a class="nav-link"  style="color:black" href="<?php echo site_url('home/about_us')?>" >About
                </a>
              </li>
            </ul>
          </div>
  ...
  <!-- End Page -->
  <!-- Footer -->
  <footer class="container footer-bottom" style="background-color:#c3c3c3">
    <div class="container">
    <div class="site-footer-legal" style="color:black">© 2017 <a style="color:#3497db" href="http://if.undip.ac.id">Universitas Diponegoro</a></div>
    <div class="site-footer-right" style="color:black">
    Created by shivatwin
    </div>
    </div>
  </footer>
