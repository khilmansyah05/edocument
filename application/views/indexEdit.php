                ...
                <li class="site-menu-item has-sub">
                  <a href="javascript:void(0)">
                    ...
                    <div class="site-menu-label">
                      <span class="tag tag-danger tag-round m-r-25">new</span>
                    </div>
                    <span class="site-menu-arrow"></span>
                  </a>
                  <ul class="site-menu-sub">
              ...
              <ul class="site-menu-sub">
                ...
                <li class="site-menu-item">
                  <a class="animsition-link" href="tables/jqtabledit.html">
                    ...
                    <div class="site-menu-label">
                      <span class="tag tag tag-info tag-round">new</span>
                    </div>
                  </a>
                </li>
              </ul>
  ...
  <div class="page">
    <div class="page-content container-fluid">
      <div class="row" data-plugin="matchHeight" data-by-row="true">
        <div class="col-xxl-7 col-lg-7 col-xs-12">
                    ...
                    <div class="pull-xs-right clearfix">
                      <ul class="list-unstyled">
                        <li class="m-b-5 text-truncate">
                          <i class="icon wb-medium-point red-600 m-r-5" aria-hidden="true"></i>                          Diretary intake
                        </li>
                        <li class="m-b-5 text-truncate">
                          <i class="icon wb-medium-point orange-600 m-r-5" aria-hidden="true"></i>                          Motion
                        </li>
                        <li class="m-b-5 text-truncate">
                          <i class="icon wb-medium-point green-600 m-r-5" aria-hidden="true"></i>                          Other
                        </li>
                      </ul>
                    </div>
                  </div>
          ...
          <div class="card card-shadow" id="widgetStackedBar">
            <div class="card-block p-0">
              <div class="p-30 h-150">
                <p>MARKET DOW</p>
                <div class="red-600">
                  <i class="wb-triangle-up font-size-20 m-r-5"></i>
                  <span class="font-size-30">26,580.62</span>
                </div>
              </div>
              <div class="counters p-b-20 p-x-30" style="height:calc(100% - 350px);">
        ...
        <div class="col-xxl-8 col-lg-12 col-xs-12">
          <!-- Widget Statistic -->
          <div class="card card-shadow" id="widgetStatistic">
            <div class="card-block p-0">
              <div class="row no-space h-full" data-plugin="matchHeight">
                ...
                <div class="col-md-4 col-sm-12 p-30 col-xs-12">
                  <div class="form-group">
                  ...
                  <p>
                    <i class="icon wb-map blue-grey-400 m-r-10" aria-hidden="true"></i>
                    <span>258 Countries, 4835 Cities</span>
                  </p>
                  <ul class="list-unstyled m-t-20">
                    <li>
                      <p>VISITS</p>
                      <div class="progress progress-xs m-b-25">
          ...
          <div class="card card-shadow card-responsive" id="widgetOverallViews">
            <div class="card-block p-30">
              <div class="row p-b-30" style="height:calc(100% - 250px);">
                ...
                <div class="col-xs-12 col-sm-4">
                  <div class="counter counter-sm text-xs-left inline-block">
          ...
          <div class="card card-shadow card-responsive" id="widgetTimeline">
            <div class="card-block p-0">
              <div class="p-30" style="height:120px;">
                <div class="row">
                  <div class="col-xs-4">
                    <div class="counter text-xs-left">
              ...
              <ul class="list-unstyled p-b-50 m-b-0" style="height:calc(100% - 270px);">
                <li class="p-x-30 p-y-15 container-fluid">
                  <div class="row">
        ...
        <div class="col-xxl-6 col-lg-12 col-xs-12">
          ...
          <div class="card card-shadow" id="widgetWeather">
            <div class="row no-space h-full">
              <div class="col-xs-12 col-md-7 h-full">
                <div class="p-35 text-xs-center">
                  <h4>California, Usa</h4>
                  <p class="blue-grey-400 m-b-35">MONDAY MAY 11, 2017</p>
                ...
                <div class="weather-times p-30">
                  <div class="row no-space text-xs-center">
                    <div class="col-xs-3">
                      <div class="weather-day vertical-align">
                        <div class="vertical-align-middle">
                          <div class="m-b-5">12:00</div>
                          <i class="wi-day-cloudy font-size-24 m-b-5"></i>
                    ...
                    <div class="col-xs-3">
                      <div class="weather-day vertical-align">
                        <div class="vertical-align-middle">
                          <div class="m-b-5">12:30</div>
                          <i class="wi-day-sunny font-size-24 m-b-5"></i>
              ...
              <div class="col-xs-12 col-md-5 bg-blue-grey-100 h-full">
          ...
          <div class="card card-shadow" id="widgetLinepointDate">
            <div class="card-block p-30">
              <h3 class="card-title">Sales Analysis
                <div class="card-header-actions">
                  <span class="tag tag-dark tag-round">View</span>
                </div>
              </h3>
              <div class="row text-xs-center m-y-25">
                <div class="col-xs-4">
                  <div class="counter">
